# EzzeSiftuz\ProductsV1\MarketplaceStatusApi
...
> \EzzeSiftuz\ProductsV1\Model\MarketPlaceStatusApiResult getMarketPlaceStatusList($product_name, $category, $brand, $page, $limit, $market_place_status)
...
try {
    $result = $apiInstance->getMarketPlaceStatusList($product_name, $category, $brand, $page, $limit, $market_place_status);
    print_r($result);
} catch (Exception $e) {
