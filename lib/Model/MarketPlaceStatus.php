...
class MarketPlaceStatus implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'sku' => 'string',
'status' => 'string',
'errors' => '\EzzeSiftuz\ProductsV1\Model\MarketPlaceStatusError[]',
'links' => '\EzzeSiftuz\ProductsV1\Model\MarketPlaceStatusLink[]',
'last_modified' => 'int'    ];
...
self::STATUS_INACTIVE,        ];
     ...
     * Gets errors
     *
     * @return \EzzeSiftuz\ProductsV1\Model\MarketPlaceStatusError[]
     */
     ...
     * Sets errors
     *
     * @param \EzzeSiftuz\ProductsV1\Model\MarketPlaceStatusError[] $errors errors that occurred when processing the variation
     *
     * @return $this
     */
     ...
     * Gets links
     *
     * @return \EzzeSiftuz\ProductsV1\Model\MarketPlaceStatusLink[]
     */
     ...
     * Sets links
     *
     * @param \EzzeSiftuz\ProductsV1\Model\MarketPlaceStatusLink[] $links contains the link to the partner variation data and to the product in OTTO shop
     *
     * @return $this
     */
