...
'attributes' => '\EzzeSiftuz\ProductsV1\Model\Attribute[]'    ];
...
'attributes' => 'getAttributes'    ];
     ...
     * Sets bullet_points
     *
     * @param string[] $bullet_points Lists some key information about a product variant a partner can provide. At least one bullet point must be provided. May contain a minimum of 3 and a maximum of 60 characters.
     *
     * @return $this
     */
     ...
     * Gets attributes
     *
     * @return \EzzeSiftuz\ProductsV1\Model\Attribute[]
     */
     ...
     * Sets attributes
     *
     * @param \EzzeSiftuz\ProductsV1\Model\Attribute[] $attributes Lists all the descriptive information about a product variant a partner can provide. Must be provided in the form of a key values pair. Will be validated against the AttributeDefinitions from Category endpoint provided by Otto market.
     *
     * @return $this
     */
