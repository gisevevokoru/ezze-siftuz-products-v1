...
class CategoriesApi
{
     ...
     * @return \EzzeSiftuz\ProductsV1\Model\CategoryGroups
     */
     ...
     * @throws \EzzeSiftuz\ProductsV1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EzzeSiftuz\ProductsV1\Model\CategoryGroups, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCategoryGroupsWithHttpInfo($page = null, $limit = null)
    {
        $returnType = '\EzzeSiftuz\ProductsV1\Model\CategoryGroups';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EzzeSiftuz\ProductsV1\Model\CategoryGroups',
