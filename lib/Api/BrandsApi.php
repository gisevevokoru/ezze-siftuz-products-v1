...
class BrandsApi
{
     ...
     * @return \EzzeSiftuz\ProductsV1\Model\Brand[]
     */
     ...
     * @throws \EzzeSiftuz\ProductsV1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EzzeSiftuz\ProductsV1\Model\Brand[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getBrandsWithHttpInfo()
    {
        $returnType = '\EzzeSiftuz\ProductsV1\Model\Brand[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EzzeSiftuz\ProductsV1\Model\Brand[]',
