...
class MarketplaceStatusApi
{
     ...
     * @param  int $limit proposed limit for the number of marketplace status per response page (at most 100) (optional)
     *
     * @throws \EzzeSiftuz\ProductsV1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EzzeSiftuz\ProductsV1\Model\MarketPlaceStatusApiResult
     */
    public function getMarketPlaceStatusList($product_name = null, $category = null, $brand = null, $page = null, $limit = null)
    {
        list($response) = $this->getMarketPlaceStatusListWithHttpInfo($product_name, $category, $brand, $page, $limit);
        return $response;
    }
     ...
     */
    public function getMarketPlaceStatusListWithHttpInfo($product_name = null, $category = null, $brand = null, $page = null, $limit = null)
    {
        $returnType = '\EzzeSiftuz\ProductsV1\Model\MarketPlaceStatusApiResult';
        $request = $this->getMarketPlaceStatusListRequest($product_name, $category, $brand, $page, $limit);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMarketPlaceStatusListAsync($product_name = null, $category = null, $brand = null, $page = null, $limit = null)
    {
        return $this->getMarketPlaceStatusListAsyncWithHttpInfo($product_name, $category, $brand, $page, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMarketPlaceStatusListAsyncWithHttpInfo($product_name = null, $category = null, $brand = null, $page = null, $limit = null)
    {
        $returnType = '\EzzeSiftuz\ProductsV1\Model\MarketPlaceStatusApiResult';
        $request = $this->getMarketPlaceStatusListRequest($product_name, $category, $brand, $page, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getMarketPlaceStatusListRequest($product_name = null, $category = null, $brand = null, $page = null, $limit = null)
    {
