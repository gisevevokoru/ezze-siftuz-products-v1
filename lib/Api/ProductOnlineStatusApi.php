...
class ProductOnlineStatusApi
{
     ...
     * @throws \EzzeSiftuz\ProductsV1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EzzeSiftuz\ProductsV1\Model\OnlineStatus
     */
     ...
     * @throws \EzzeSiftuz\ProductsV1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EzzeSiftuz\ProductsV1\Model\OnlineStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVariationOnlineStatusWithHttpInfo($sku)
    {
        $returnType = '\EzzeSiftuz\ProductsV1\Model\OnlineStatus';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EzzeSiftuz\ProductsV1\Model\OnlineStatus',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * DEPRECATED - please use the corresponding active-status endpoint instead.
     *
     * @param  \EzzeSiftuz\ProductsV1\Model\OnlineStatusListRequest $body body (optional)
     ...
     * DEPRECATED - please use the corresponding active-status endpoint instead.
     *
     * @param  \EzzeSiftuz\ProductsV1\Model\OnlineStatusListRequest $body (optional)
     * @param  \DateTime $x_request_timestamp Holds the client side update request timestamp (optional)
     *
     * @throws \EzzeSiftuz\ProductsV1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
